...
Status: prepared, **not built or validated in Linux/container**, not deployed. Existing production Dockerfile, worker, preview gate and deployment configuration are unchanged. No local image build or model download was attempted; local free space was near the 30 GiB guard.
