...
1. Freeze the exact current production Advanced payloads and source lineage for every visible base before comparing a new producer. Separate source rests and N.C. from missing harmony; retain exact meter/pickup boundaries.
